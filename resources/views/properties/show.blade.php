...
@section('header-meta')
    ...
    <meta property="og:title"              content="House me now | Buy and sell properties | {{ $property->street . ', ' . $property->city . ', ' . $property->state . ', ' . $property->country }}" />
...
@section('content')
    ...
    <div class="container">
        ...
        <main>
            ...
            <div itemscope itemtype="http://schema.org/Product" class="row property">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <h1 itemprop="name">{{ $property->street }}</h1>

                        <span  itemprop="offers" itemscope itemtype="http://schema.org/Offer"><h2 itemprop="price">{!! $property->price ? "$" . number_format($property->price) : "Contact for price" !!}</h2></span>
                    ...
                    <div class="row">
                        ...
                        <div class="details">
                            ...
                            <div id="description-collapse" class="description collapse well">
                                ...
                                <p itemprop="description">{!! nl2br($property->description) !!}</p>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 gallery-image">
                                    ...
                                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                        <a href="{{ $photo->path }}" itemprop="contentUrl" data-size="{{ $photo->size['width'] . 'x' . $photo->size['height'] }}">
                                            <img itemprop="image" src="{{ $photo->thumbnail_path }}" itemprop="thumbnail" alt="{{ $property->street }}" style="max-width: 200px;" />
